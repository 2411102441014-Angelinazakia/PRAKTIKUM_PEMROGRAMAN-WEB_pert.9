...
<body>
    ...
    echo "<p>Nilai penjualan salesman : Rp. " . $nilaiJual . "</p>";   // tampilkan nilai penjualan
    echo "<p>Prosentase Komisi : " . $prosenKomisi . " %</p>";        // tampilkan persen komisi
    echo "<p>Komisi yang didapat salesman adalah Rp. " . $komisi . "</p>"; // tampilkan hasil komisi
    ?>
</body>
</html>
