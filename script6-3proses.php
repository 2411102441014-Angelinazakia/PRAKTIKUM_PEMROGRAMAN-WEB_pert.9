...
<body>
    ...
    $totalDetik1 = $jam1 * 3600 + $menit1 * 60 + $detik1;   // hitung total detik waktu pertama
    $totalDetik2 = $jam2 * 3600 + $menit2 * 60 + $detik2;   // hitung total detik waktu kedua

    $selisih = $totalDetik1 - $totalDetik2;                 // hitung selisih total detik
